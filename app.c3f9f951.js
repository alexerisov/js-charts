...
function toDate(timestamp) {
  var shortMonths = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Dec', 'Nov'];
...
},{"./utils":"js/utils.js"}],"js/slider.js":[function(require,module,exports) {
"use strict";
...
function sliderChart(root, data, DPI_WIDTH) {
  ...
  yData.map((0, _utils.toCoords)(xRatio, yRatio, DPI_HEIGHT, -5, yMin)).forEach(function (coords, idx) {
...
},{"./utils":"js/utils.js"}],"js/chart.js":[function(require,module,exports) {
"use strict";
...
function chart(root, data) {
  ...
  function paint() {
    ...
    var max = getMax(yMax); // const min = getMin(yMin)
...
},{"./tooltip":"js/tooltip.js","./utils":"js/utils.js","./slider":"js/slider.js"}],"js/data.json":[function(require,module,exports) {
module.exports = [{
...
var tgChart = (0, _chart.chart)(document.getElementById('chart'), _data.default[1]);
tgChart.init();
},{"./chart":"js/chart.js","./data.json":"js/data.json","./../css/styles.scss":"css/styles.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
